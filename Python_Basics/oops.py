"""
    class:
        ...
        "class" is the kwyword, used to declare the class
        "pass" is the keyword, used to create "empty class"
        constuctors are used to "declare data / initilize data" dynamically
...
#print(obj1.sub)  #Super AI
#print(obj2.sub)  #Agentic AI
